	...
	<div class="container">
	 	...
	 	<div class="col-lg-4">
	 		<div class="jumbotron" style="padding-top: 20px;">
	 			<form method="post" action="joinAction.jsp"> <!-- 로그인액션의 페이지에 로그인 정보를 보내주겠다 -->
	 				...
	 				<div class="form-group">
	 					<input type="text" class="form-contorl" placeholder="이름" name="userName" maxlength="20">
	 				</div>	
	 				<div class="form-group"	style="text-align: center;">
	 					...
	 					<div class="form-group">
	 					<input type="email" class="form-contorl" placeholder="이메일" name="userEmail" maxlength="20">
	 				</div>	
	 				</div>									
